...
struct ImportFlow_Previews: PreviewProvider {
    static var previews: some View {
        ...
        ImportFlow(model: .init(initialStep: .importing(.init(publicKey: PrivateKey().publicKey, encryptedVault: Data(), keyDerivationSalt: Data(), encryptionNonce: .init(), authenticationTag: .init())), completion: { _  in
